\doxysection{gui/node\+\_\+modules/graceful-\/fs Directory Reference}
\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73}{}\label{dir_82b6e5612219c8e81b5e7845153d8c73}\index{gui/node\_modules/graceful-\/fs Directory Reference@{gui/node\_modules/graceful-\/fs Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md893}{}\doxysubsection{\texorpdfstring{graceful-\/fs}{graceful-\/fs}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md893}
graceful-\/fs functions as a drop-\/in replacement for the fs module, making various improvements.

The improvements are meant to normalize behavior across different platforms and environments, and to make filesystem access more resilient to errors.\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md894}{}\doxysubsection{\texorpdfstring{Improvements over \href{https://nodejs.org/api/fs.html}{\texttt{fs module}}}{Improvements over \href{https://nodejs.org/api/fs.html}{\texttt{fs module}}}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md894}
...
On Windows, it retries renaming a file for up to one second if {\ttfamily EACCESS} or {\ttfamily EPERM} error occurs, likely because antivirus software has locked the directory.\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md895}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md895}
...
\end{DoxyCode}
\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md896}{}\doxysubsection{\texorpdfstring{Sync methods}{Sync methods}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md896}
...
This is a known limitation, not a bug.\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md897}{}\doxysubsection{\texorpdfstring{Global Patching}{Global Patching}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md897}
...
This should only ever be done at the top-\/level application layer, in order to delay on EMFILE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md898}{}\doxysubsection{\texorpdfstring{Changes}{Changes}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md898}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of Node from 0.\+8 through 7.\+0.\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md899}{}\doxysubsubsection{\texorpdfstring{v4}{v4}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md899}
...
\end{DoxyItemize}\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md900}{}\doxysubsubsection{\texorpdfstring{v3}{v3}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md900}
...
\end{DoxyItemize}\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md901}{}\doxysubsubsection{\texorpdfstring{v2.\+1.\+0}{v2.\+1.\+0}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md901}
...
\end{DoxyItemize}\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md902}{}\doxysubsubsection{\texorpdfstring{v2.\+0}{v2.\+0}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md902}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md903}{}\doxysubsubsection{\texorpdfstring{v1.\+1}{v1.\+1}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md903}
...
\end{DoxyItemize}\hypertarget{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md904}{}\doxysubsubsection{\texorpdfstring{1.\+0}{1.\+0}}\label{dir_82b6e5612219c8e81b5e7845153d8c73_autotoc_md904}
